<!DOCTYPE html>
<%@page import="webService.InformacioAccessibilitatLocal"%>
...
@media screen and (max-height: 450px) {
  ...
  .sidenav a {font-size: 18px;}
            ...
            <body>
                ...
                <% InformacioAccessibilitatLocal[] accessibilitat = null;
                try{
					...
					accessibilitat = port.llistarAccessibilitatLocal(Integer.parseInt(id));
				}
				catch (Exception e) { 
					e.printStackTrace();
				}
				...
				%>
                    ...
                    <h2>INFORMACIÓ D'ACCESSIBILITAT DEL LOCAL</h2>
					...
					<table>
					 ...
					 <%for (int i=0; i<accessibilitat.length; i++){%>
					  <tr>
					    <td><%=accessibilitat[i].getNomCaracteristicaCA()%></td>
					    <td><%=accessibilitat[i].getValor()%></td>
					  </tr>
					  <%} %>
					
					</table>
					<form method="post" action="SvlVerificar">
						<input type="hidden" value=<%= id %> name="codiLocal">
						<input type="submit" value="Verifica el local">
					</form>
