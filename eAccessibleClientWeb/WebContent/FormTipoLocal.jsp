  ...
  .sidenav a {font-size: 18px;}
            ...
            <body>
                ...
                <div class="main">
					...
					%>
                    <h5>Tipus de local a donar d'alta</h5>
                    <form action="SvlTipoLocal" method="post">
                        <ul>
                            <li>
                                <label for="name">Tipus Local:</label>
                        ...
                        <input type="submit" value="Continuar amb l'alta del local">
                        </form>
                    </div>
                    <script>
