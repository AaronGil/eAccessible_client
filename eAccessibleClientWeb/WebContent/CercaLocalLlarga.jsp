...
@media screen and (max-height: 450px) {
  ...
  .sidenav a {font-size: 18px;}
            ...
            <body>
				...
				EAccessibleWebServiceServiceLocator service = new EAccessibleWebServiceServiceLocator();
				
				EAccessibleWebService port = service.geteAccessibleWebServicePort();
				
				tipoLocal = port.llistarTipusLocals();
				...
				%>
					...
					<form method="post" action="SvlCercaLlarga">
					
					 
					
						<h5>Cerca un local pel seu tipus, nom i numero:</h5>
						...
						<input type="text" name="numeroLocal">
						 
						
						<br>
						
						<input type="submit" value="CercarLocal">
